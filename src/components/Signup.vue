...
<form class="form-signin">
  ...
  <div class="form-label-group signelem">
    ...
    <input type="password" id="inputRetryPassword" class="form-control" placeholder="Retry Password" required v-model="retrypassword">
  </div>
  <div class="form-label-group signelem">
  ...
  <div class="form-label-group signelem">
    ...
    <input type="text" id="inputName" class="form-control" placeholder="Name" required autofocus v-model="name">
  </div>
  <div class="form-label-group signelem">
    <label for="inputAge">Age</label>
    <input type="number" id="inputAge" class="form-control" placeholder="Age" required autofocus v-model="age">
  </div>
   <div class="form-label-group signelem">
  ...
  <div class="form-label-group signelem">
    ...
    <input type="text" id="inputCity" class="form-control" placeholder="City" required autofocus v-model="city">
  </div>
  <div class="form-label-group signelem">
    <label for="inputSpecialization">Specialization</label>
    <input type="text" id="inputSpecialization" class="form-control" placeholder="Specialization" required autofocus v-model="specialization">
  </div>
  
  <button class="btn btn-lg btn-primary btn-block btn-sign" @click.prevent="signupfun">Sign up</button>
</form>
