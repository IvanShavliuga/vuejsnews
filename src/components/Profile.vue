<template>
  <div class="profile">
    <nav class="nav">
      <a
        :class="['nav-link', activelink == 0 ? 'active' : '']"
        href="#"
        @click="activelink = 0"
      >
        Profile</a
      ...
      >
        Messages
        <span class="badge badge-success">{{ messages.length }}</span></a
      >
      <a
      ...
      >
      <a
        :class="['nav-link', activelink == 3 ? 'active' : '']"
        href="#"
        @click="activelink = 3"
      >
      ...
      >
      <a
        :class="['nav-link', activelink == 5 ? 'active' : '']"
        href="#"
        @click="activelink = 5"
      >
        Personal posts
        <span class="badge badge-success">{{ personalposts.length }}</span></a
      >
      <a
        :class="['nav-link', activelink == 6 ? 'active' : '']"
        href="#"
        @click="activelink = 6"
      >
        Add post</a
      >
      <a
        :class="['nav-link', activelink == 7 ? 'active' : '']"
        href="#"
        @click="activelink = 7"
      >
        Add group</a
      >
      <a
        :class="['nav-link', activelink == 8 ? 'active' : '']"
        href="#"
        @click="activelink = 8"
      >
        You cards
        <span class="badge badge-success">{{ personalcards.length }}</span></a
      >
    </nav>
